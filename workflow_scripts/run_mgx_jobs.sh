...
python3 -u workflow_scripts/test_models.py --all_models --target migraphx --quant fp32
...
python3 -u workflow_scripts/test_models.py --all_models --target migraphx --quant fp16
...
python3 -u workflow_scripts/test_models.py --all_models --target migraphx --quant fp32-int8
...
python3 -u workflow_scripts/test_models.py --all_models --target migraphx --quant fp32-qdq
